        ...
        <div className='about'>
            ...
            <section className="about-content">
                <article className="content-1">
                    ...
                    <p>Stripes Nation began as a passion project by Christian Yip, a dedicated hockey official. Driven by his love for the sport, he created a brand that reflected the spirit and values of the officiating community. The logo, font, and icons were carefully designed to evoke the elements of the referee uniform and the game's fast-paced nature. With a vision for a fully functioning brand, Christian continued to leverage his design and web development expertise.</p>
                </article>
