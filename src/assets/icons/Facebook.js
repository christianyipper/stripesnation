    ...
    return (
        <svg className={`icon ${iconclass}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
            <g id="Outline">
                ...
                <path class="icon-stroke" d="M29.43,38.46h-5.44v-9.95h-3.62v-4.52h3.62v-3.62c0-1.44.57-2.81,1.59-3.84,1.01-1.01,2.39-1.59,3.84-1.59h3.62v4.52h-1.8c-1,0-1.8-.09-1.8.9v3.62h4.52l-1.8,4.52h-2.71v9.95h0Z"/>
